...
//------------------------------------------------------------------------------
void FitHorn_Cut150MeV()
{

  const double EnergyCut = 150;
  const double EnergyCutHe = 70;
  ...
  FileOut << setw(5) <<"*tel" <<"  "<< setw(5) << "csi" <<"  "<<setw(5)<< "Z" <<"  "<<setw(5)<< "A" <<"  "<< setw(35) <<"Horn's Formula"
             << setw(7) << " Npar "<<setw(45) << "Par0" <<"  "<< setw(10) <<"Par1"<<"  "<<setw(10)<<"Par2\n";
...
//______________________________________________________________________________
  ...
  TF2 *fHeavyIon= new TF2("fHeavyIon",HornFit,0,150,300,500,3);
  fHeavyIon->SetParameters(0.001,0.01,0.1);
  TF2 *fHelium= new TF2("fHelium",HornFit,0,150,200,300,3);
  fHelium->SetParameters(0.001,0.01,0.1);


  TF1 * fHe3 = new TF1("fHe3",fit_He3,0,150,3);
  TF1 * fHe4 = new TF1("fHe4",fit_He4,0,150,3);
  TF1 * fHe6 = new TF1("fHe6",fit_He6,0,150,3);
  TF1 * fLi6 = new TF1("fLi6",fit_Li6,0,150,3);
  TF1 * fLi7 = new TF1("fLi7",fit_Li7,0,150,3);
  TF1 * fLi8 = new TF1("fLi8",fit_Li8,0,150,3);
  TF1 * fBe7 = new TF1("fBe7",fit_Be7,0,150,3);
  TF1 * fBe9 = new TF1("fBe9",fit_Be9,0,150,3);
...
//______________________________________________________________________________
  ...
  //    if(i!=5) continue;
      ...
      TotGraph[i][j]->Fit("fHelium");

      fHe3->SetParameters(fHelium->GetParameters());
      fHe4->SetParameters(fHelium->GetParameters());
      fHe6->SetParameters(fHelium->GetParameters());
      ...
      c1->Print(Form("pictures/HornFit_TEL%02d_CSI%02d.png",i,j));
      ...
      double par0Helium = fHelium->GetParameter(0);
      double par1Helium = fHelium->GetParameter(1);
      double par2Helium = fHelium->GetParameter(2);
      int Z;
      int A;
	...
	if(Z>2) FileOut << setw(5) << i <<"  "<< setw(5) << j <<"  "<<setw(5)<< Z <<"  "<<setw(5)<< A <<"  "<< setw(35)<< Form("[0]+[1].(x-[2].%d.pow(%d,2).log(fabs((x+[2].%d.pow(%d,2))/([2].%d.pow(%d,2)))))",A,Z,A,Z,A,Z) << setw(7) << " 3 "<<setw(15) << par0 <<"  "<< setw(10) << par1 <<"  "<<setw(10)<< par2 <<endl;
        if(Z==2) FileOut << setw(5) << i <<"  "<< setw(5) << j <<"  "<<setw(5)<< Z <<"  "<<setw(5)<< A <<"  "<< setw(35)<< Form("[0]+[1].(x-[2].%d.pow(%d,2).log(fabs((x+[2].%d.pow(%d,2))/([2].%d.pow(%d,2)))))",A,Z,A,Z,A,Z) << setw(7) << " 3 "<<setw(15) << par0Helium <<"  "<< setw(10) << par1Helium <<"  "<<setw(10)<< par2Helium <<endl;
      }
    }
  }
//______________________________________________________________________________
