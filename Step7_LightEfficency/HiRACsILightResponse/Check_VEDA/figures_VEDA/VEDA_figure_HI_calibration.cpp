...
void VEDA_figure_HI_calibration()
{
  ...
  TF1 * Fit_Z02_A03 = new TF1 ("Fit_Z02_A03", fit_HornFenhai_He3, 0, 2000, NumParameters_Z02_A03);
  TF1 * Fit_Z02_A04 = new TF1 ("Fit_Z02_A04", fit_HornFenhai_He4, 0, 2000, NumParameters_Z02_A04);
  TF1 * Fit_Z02_A06 = new TF1 ("Fit_Z02_A06", fit_HornFenhai_He6, 0, 2000, NumParameters_Z02_A06);
  TF1 * Fit_Z03_A06 = new TF1 ("Fit_Z03_A06", fit_HornFenhai_Li6, 0, 2000, NumParameters_Z03_A06);
  TF1 * Fit_Z03_A07 = new TF1 ("Fit_Z03_A07", fit_HornFenhai_Li7, 0, 2000, NumParameters_Z03_A07);
  TF1 * Fit_Z03_A08 = new TF1 ("Fit_Z03_A08", fit_HornFenhai_Li8, 0, 2000, NumParameters_Z03_A08);
  TF1 * Fit_Z04_A07 = new TF1 ("Fit_Z04_A07", fit_HornFenhai_Be7, 0, 2000, NumParameters_Z04_A07);
  TF1 * Fit_Z04_A09 = new TF1 ("Fit_Z04_A09", fit_HornFenhai_Be9, 0, 2000, NumParameters_Z04_A09);
  ...
  TPad * TheInsert = new TPad("TheInsert", "", 0.60,0.11,0.90,0.50);
  TheInsert->Draw("SAME");
  TheInsert->cd();
  ...
  c1->Print("VEDA_figure_HI_calibration.png");
