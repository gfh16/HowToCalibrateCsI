...
void Step1_DEEPoints_2nd_MakeProjectionY()
{
  TFile * FileIn = new TFile("RootData/HiRA_DECal_CsIRaw_Pixelization.root");
  TFile * FileInCuts = new TFile("RootData/HiRA_DECal_CsIRaw_Cuts.root");
...
//  FileOut << setw(5) << "*tel  " << setw(7) << "numcsi " << setw(10) << "CsI (ch) " << setw(10) << "err CsI (ch) " << setw(10) << "CsI (V) " << setw(10) << "err CsI (V) " << setw(10) << "Si (MeV) " << setw(10) << "err Si (MeV)\n";
 ...
 //     c1->Print(Form("pictures/4HeLowEnergy/HiRA_CsI_DEEProfiling%s_Z%02d_A%02d_%02d_%02d.png", FileOutTag.c_str(), Z, A, i, j));
      c1->Print(Form("pictures/DEEPoints/HiRA_CsI_DEEProfiling%s_Z%02d_A%02d_%02d_%02d.png",FileOutTag.c_str(), Z, A, i, j));
