...
{
//  ofstream FileOut;
//  FileOut.open("data/SimultaneouslyFit_ZEqual2.dat");
...
//______________________________________________________________________________
  ...
  TF2 *fHeavyIon= new TF2("fHeavyIon",HornFit,0,100,200,206,3);
  fHeavyIon->SetParameters(-0.01,0.01,0.1);

  TF1 * fHe3 = new TF1("fHe3",fit_He3,0,300,3);
  TF1 * fHe4 = new TF1("fHe4",fit_He4,0,300,3);
  TF1 * fHe6 = new TF1("fHe6",fit_He6,0,300,3);
