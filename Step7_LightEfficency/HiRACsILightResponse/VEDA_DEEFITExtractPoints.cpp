...
//  std::string FileOutTag("InChannel");
  ...
  ifstream FileIn("data_VEDA/DEEFITPointsFullInfo_VEDA.dat");
  ofstream FileOut(Form("data_VEDA/VEDA_DEEPoints%s_Z%02d_A%02d.dat",FileOutTag.c_str(),Z, A));
