...
////////////////////////////////////////////////////////////////////////////////
double HornFitZOver2(double *x, double *par)
{
  // x[0]--E, x[1]--A
  if(x[1]>300)
  {
...
{
  ofstream FileOut;
  FileOut.open("data/SimultaneouslyFitPar_ZOver2.dat");
...
//______________________________________________________________________________
  ...
  TF2 *fHeavyIon= new TF2("fHeavyIon",HornFitZOver2,0,500,200,500,5);
