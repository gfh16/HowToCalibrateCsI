void Step3_KinPoints_1st_BulidHist()
{
...
*/
 ...
 // I declare here a File to e used as output
  TFile FileOut(Form("Step3_KinematicPoints/NewGeo_HiRA_KinematicPlots_%2d_%2d_%2dCa+1H@%.1fAMeV.root",FirstRun,LastRun,A_beam,E_projectile),"RECREATE");
