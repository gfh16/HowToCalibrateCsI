...
void Step7_LightResponse_1st_DEEPoints()
{
  int Z=1;
  int A=1;
...
//  std::string FileOutTag("InVoltage");
  ...
  ifstream FileIn(Form("data/DEEFITPointsFullInfo.dat"));
  ofstream FileOut(Form("data/LightEfficiencyData%s_Z%02d_A%02d.dat",FileOutTag.c_str(), Z, A));
