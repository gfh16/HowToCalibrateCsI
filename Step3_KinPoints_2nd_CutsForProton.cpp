void Step3_KinPoints_2nd_CutsForProton()
{
  ...
  std::string path_to_file (Form("RootData/NewGeo_HiRA_KinematicPlots_%4d_%4d_%2dCa+1H@%.1fAMeV.root",FirstRun,LastRun,A_beam,E_projectile));
  TFile* FileIn = new TFile(path_to_file.c_str());

  TFile* fileout = new TFile(Form("RootData/Test_NewGeo_HiRA_KinematicPlotsCut_%4d_%4d_%2dCa+1H@%.1fAMeV.root",FirstRun,LastRun,A_beam,E_projectile), "UPDATE");
