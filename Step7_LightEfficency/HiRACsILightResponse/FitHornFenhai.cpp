...
void FitHornFenhai()
{
  ...
  FileIn_name_He3[0] = new std::string("data/DEEPointsInVoltage_Z02_A03.dat"); //DEE points
  ...
  FileIn_name_He4[0] = new std::string("data/DEEPointsInVoltage_Z02_A04.dat"); //DEE points
  FileIn_name_He4[1] = new std::string("data/WMUdataAddOnePecenterrEnergy_Z02_A04.dat");
  ...
  FileIn_name_He6[0] = new std::string("data/DEEPointsInVoltage_Z02_A06.dat"); //DEE points
  ...
  FileIn_name_Li6[0] = new std::string("data/DEEPointsInVoltage_Z03_A06.dat"); //DEE points
  ...
  FileIn_name_Li7[0] = new std::string("data/DEEPointsInVoltage_Z03_A07.dat"); //DEE points
  ...
  FileIn_name_Li8[0] = new std::string("data/DEEPointsInVoltage_Z03_A08.dat"); //DEE points
  ...
  FileIn_name_Be7[0] = new std::string("data/DEEPointsInVoltage_Z04_A07.dat"); //DEE points
  ...
  FileIn_name_Be9[0] = new std::string("data/DEEPointsInVoltage_Z04_A09.dat"); //DEE points
