...
////////////////////////////////////////////////////////////////////////////////
//// definition of the fitting formula for proton, deuteron and triton
//// this formula comes from Fenhai 
//// The trend is linear at low energy and includes a saturation effects at higher energies
//// the saturation effect is more pronounced for lighter isotopes
////////////////////////////////////////////////////////////////////////////////
//______________________________________________________________________________
...
void FitPDT()
{
  ...
  FileIn_name_Proton[0] = new std::string("data/WMUdataAddOnePecenterrEnergy_Z01_A01.dat");   // WMU data
  FileIn_name_Proton[1] = new std::string("data/DEEPointsOmitLow_Z01_A01.dat"); //DEE points
  FileIn_name_Proton[2] = new std::string("data/Corrected_HiRA_CsIKinimatics_2013_2037_40Ca39.0AMeV_gain 200.dat"); // kinematics ponits
  FileIn_name_Proton[3] = new std::string("data/Corrected_HiRA_CsIKinimatics_2312_2312_40Ca56.6AMeV_gain 170.dat"); // kinematics ponits
  //FileIn_name_Proton[4] = new std::string("data/Corrected_HiRA_CsIKinimatics_2825_2829_40Ca139.8AMeV_gain 130.dat"); // kinematics ponits
  FileIn_name_Proton[4] = new std::string("data/Corrected_HiRA_CsIKinimatics_4000_4005_48Ca139.8AMeV_gain 170.dat"); // kinematics ponits
  FileIn_name_Proton[5] = new std::string("data/Corrected_HiRA_CsIKinimatics_4021_4022_48Ca139.8AMeV_gain 170.dat"); // kinematics ponits
  FileIn_name_Proton[6] = new std::string("data/Corrected_HiRA_CsIKinimatics_4034_4037_48Ca28.0AMeV_gain 170.dat"); // kinematics ponits
  FileIn_name_Proton[7] = new std::string("data/Corrected_HiRA_CsIKinimatics_4332_4332_48Ca56.6AMeV_gain 170.dat"); // kinematics ponits
  FileIn_name_Proton[8] = new std::string("data/Corrected_HiRA_CsIKinimatics_4577_4584_48Ca28.0AMeV_gain 170.dat"); // kinematics ponits
  FileIn_name_Proton[9] = new std::string("data/Corrected_HiRA_CsIKinimatics_4585_4589_48Ca56.6AMeV_gain 170.dat"); // kinematics ponits
  FileIn_name_Proton[10] = new std::string("data/HiRA_CsI_PunchThrough_Z01_A01.dat");  // punch through points
  ...
  FileIn_name_Deuteron[0] = new std::string("data/WMUdataAddOnePecenterrEnergy_Z01_A02.dat");   // WMU data
  FileIn_name_Deuteron[1] = new std::string("data/DEEPointsOmitLow_Z01_A02.dat"); //DEE points
  FileIn_name_Deuteron[2] = new std::string("data/HiRA_CsI_PunchThrough_Z01_A02.dat");  // punch through points
  ...
  FileIn_name_Triton[0] = new std::string("data/DEEPointsOmitLow_Z01_A03.dat"); //DEE points
  FileIn_name_Triton[1] = new std::string("data/HiRA_CsI_PunchThrough_Z01_A03.dat");  // punch through points
  ...
  for(int FileNum=0; FileNum<NFiles_Triton; FileNum++)
  {
    ...
    for(int i=0; i<12; i++)
    {
      for(int j=0; j<4; j++)
      {
        ...
        DataTriton[i][j][FileNum]->SetMarkerColor(kBlue); // black marker for Tritons
        DataTriton[i][j][FileNum]->SetLineColor(kBlue);
...
//______________________________________________________________________________
  ...
  //    TotGraph[i][j]->Draw("AP");
      ...
      c1->Print(Form("pictures/FenhaiFit_TEL%02d_CSI%02d.png",i,j));
      ...
      for(int k=0; k<ZA_Hydrogen[i][j].size();k++)
      {
        ...
        FileOut << setw(5) << i <<"  "<< setw(5) << j <<"  "<<setw(5)<< Z <<"  "<<setw(5)<< A <<"  "<< setw(35)<< Form("[0]+[1].x^((%d+[2])/(%d+[3]))", A,A) << "  "<<setw(15) << 4 <<"  "<< setw(10) << par0 <<"  "<< setw(10) << par1 <<"  "<<setw(10)<< par2 << setw(10) << par3 <<endl;
      }
     }
   }
//______________________________________________________________________________
