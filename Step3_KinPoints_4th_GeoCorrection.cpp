...
void Step3_KinPoints_4th_GeoCorrection()
{
...
// c1->Divide(2,1);
   ...
   ifstream FileInOfInitialGeo(Form("RootData/NewGeo_HiRA_CsIKinematics_FullInfo_%4d_%4d_%dCa%.1fAMeV_gain%4d.dat", FirstRun, LastRun, A_beam, E_projectile, csi_gain_setting));
   ifstream FileInOfBeamShift(Form("Step3_KinematicPoints/GeoCorrection/pixelAngleWithError_%.1fMeV.dat", E_projectile));

   ofstream FileOutCorrected(Form("Step3_KinematicPoints/GeoCorrection/Corrected_HiRA_CsIKinimatics_%4d_%4d_%dCa%.1fAMeV_gain%4d.dat", FirstRun, LastRun, A_beam, E_projectile, csi_gain_setting));
